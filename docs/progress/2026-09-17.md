...
The part of the site your members see after they log in also has the new look now: their dashboard, their programmes, the resource library, the videos and the account page, plus the log in and sign up screens themselves.

This area was built before the new design, so it was left until last. Two things there were genuinely broken rather than just dated, and both are fixed: several buttons had become black on a black background, so only the words showed and the button shape had disappeared, and the logo in the sidebar was pointing at a file that does not exist, so it showed as a broken image on every page of the member area.
...
- The PayPal button on the checkout page was still PayPal blue, the last spot of colour on the site. It is now black like every other button.
