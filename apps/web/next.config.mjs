...
{ source: '/what-i-do',                   destination: '/services', permanent: true },
      ...
      { source: '/services/rapid-transformational-therapy',        destination: '/services/private-sessions/rapid-transformational-therapy', permanent: true },
      ...
      // NOTE: /services/private-sessions and /services/private-sessions/:path* are
      // intentionally NOT redirected — those routes now serve the live Private
      // Session hub + detail pages.
      ...
      // Transformation Pathways — old flat WP URLs → new nested routes
      { source: '/break-the-loop',                             destination: '/transformation-pathways/break-the-loop',                             permanent: true },
      { source: '/reclaim-your-power',                         destination: '/transformation-pathways/reclaim-your-power',                         permanent: true },
      { source: '/reinvent-your-life',                         destination: '/transformation-pathways/reinvent-your-life',                         permanent: true },
      { source: '/upgrade-your-operating-system',              destination: '/transformation-pathways/upgrade-your-operating-system',              permanent: true },
      { source: '/trauma-to-breakthrough',                     destination: '/transformation-pathways/trauma-to-breakthrough',                     permanent: true },
      { source: '/resilience-fortification',                   destination: '/transformation-pathways/resilience-fortification',                   permanent: true },
      { source: '/pattern-mastery',                            destination: '/transformation-pathways/pattern-mastery',                            permanent: true },
      { source: '/children-young-people-foundations-for-life', destination: '/transformation-pathways/children-young-people-foundations-for-life', permanent: true },
      { source: '/emotional-mastery-for-young-minds',          destination: '/transformation-pathways/emotional-mastery-for-young-minds',          permanent: true },
      { source: '/young-minds-architecture',                   destination: '/transformation-pathways/young-minds-architecture',                   permanent: true },
      { source: '/pattern-foundations',                        destination: '/transformation-pathways/pattern-foundations',                        permanent: true },
      { source: '/inner-compass',                              destination: '/transformation-pathways/inner-compass',                              permanent: true },
      ...
      { source: '/energetic-clearing',                              destination: '/services/private-sessions/energetic-realignment-optimisation', permanent: true },
      { source: '/group-family-coaching',                           destination: '/services/private-sessions/group-family-coaching', permanent: true },
      ...
      { source: '/akashic-clearing',                                destination: '/services/private-sessions/akashic-intuitive-mastery', permanent: true },
      { source: '/meditation',                                      destination: '/services', permanent: true },
      { source: '/mental-health',                                   destination: '/services', permanent: true },
      { source: '/resonance-repatterning-session',                  destination: '/services/private-sessions/resonance-repatterning', permanent: true },
      { source: '/rapid-repatterning-2',                            destination: '/services/private-sessions/rapid-repatterning', permanent: true },
      ...
      { source: '/transformational-behavioural-coaching',           destination: '/services/private-sessions/transformational-coaching', permanent: true },
      ...
      { source: '/exploring-the-alpha-mind',                        destination: '/services/private-sessions/exploring-the-alpha-mind', permanent: true },
