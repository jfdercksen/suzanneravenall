...
export default function PatternHubMethod() {
  return (
    <section aria-labelledby="pattern-hub-method-heading" className="w-full bg-brand-sand py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2
            ...
            className="text-3xl lg:text-5xl font-medium tracking-tight text-brand-primary leading-tight mb-4"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-8 mb-16 lg:mb-20">
          {layers.map((layer, idx) => (
            ...
            >
              <p className="text-brand-accent font-semibold text-2xl mb-3">{layer.number}</p>
              <h3 className="text-lg font-medium text-brand-primary mb-2">{layer.title}</h3>
              <p className="text-sm text-brand-muted leading-relaxed">{layer.description}</p>
            </motion.div>
          ))}
        </div>
