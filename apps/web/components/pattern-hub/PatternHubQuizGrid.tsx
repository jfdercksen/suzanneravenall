        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {patternQuizzes.map((quiz, idx) => (
            <motion.div
              ...
              className="flex flex-col h-full rounded-card bg-white shadow-sm border border-brand-border p-6 transition-all duration-500 hover:shadow-lg hover:border-brand-primary-300 hover:-translate-y-1"
            >
