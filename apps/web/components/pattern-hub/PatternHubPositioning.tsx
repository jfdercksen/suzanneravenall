...
export default function PatternHubPositioning() {
  return (
    <section aria-labelledby="pattern-hub-positioning-heading" className="w-full bg-brand-sand py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <motion.h2
            ...
            className="text-3xl lg:text-5xl font-medium tracking-tight text-brand-primary leading-tight mb-8"
          >
