        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-4xl self-center">
            ...
            <motion.h1
              ...
              {...fadeUp(0.1)}
              className="text-4xl sm:text-5xl lg:text-6xl font-medium tracking-tight text-brand-primary leading-[1.05] mb-8"
            >
              Discover the Pattern Running Your Life
            </motion.h1>

            <motion.div {...fadeUp(0.2)} className="text-lg text-brand-muted font-light mb-4 space-y-2">
              <p>
            ...
            <motion.div {...fadeUp(0.3)} className="flex flex-col sm:flex-row gap-4 mt-10">
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-brand-accent-600 hover:bg-brand-accent-700 text-white font-medium text-sm rounded-button transition-colors duration-300 whitespace-nowrap"
              >
                Start with Emotional Patterns
              </Link>
              <a
                href="#assessments"
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-brand-primary-300 hover:border-brand-primary text-brand-muted hover:text-brand-primary font-medium text-sm rounded-button transition-colors duration-300 whitespace-nowrap"
              >
