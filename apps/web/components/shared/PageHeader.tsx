...
// HEADER RULE (.claude/rules/design-rules.md) for inner pages with a photo,
// the template Johan approved on the 15 Sep design canvas. The picture is the
// header: it shows at full strength and the text sits on a black band at its
// bottom edge. Below sm the picture takes the top 320px and the text sits on
// black beneath it, so nothing covers a face. components/home/Hero.tsx and
// components/about/AboutHero.tsx are the video versions of the same rule.
    ...
    >
      <div aria-hidden="true" className="absolute inset-x-0 top-0 h-80 sm:h-full">
        <Image
          ...
          priority
          sizes="100vw"
          className={`object-cover ${mobileCrop} sm:object-center`}
        />
      </div>
