        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
                  ...
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="bg-brand-sand">
                        ...
                        <th className="text-left px-4 py-3 text-brand-ink font-medium border border-brand-border">Provider</th>
                        <th className="text-left px-4 py-3 text-brand-ink font-medium border border-brand-border">Purpose</th>
                        <th className="text-left px-4 py-3 text-brand-ink font-medium border border-brand-border">Duration</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border font-mono text-xs">sb-*-auth-token</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">Supabase</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">Stores your authentication session to keep you logged in to the member portal</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">Session / 7 days</td>
                      </tr>
              ...
              <div className="mb-8">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    ...
                    <tbody>
                      <tr>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border font-mono text-xs">_ga, _ga_*</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">Google Analytics 4</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">Distinguishes users and tracks page interactions for aggregated analytics</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">2 years</td>
                      </tr>
                      <tr className="bg-brand-sand">
                        <td className="px-4 py-3 text-brand-ink border border-brand-border font-mono text-xs">_clck, _clsk, CLID</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">Microsoft Clarity</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">Session recording and heatmap analytics: helps us improve page usability</td>
                        <td className="px-4 py-3 text-brand-ink border border-brand-border">1 year / session</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div>
              ...
              <ul className="list-disc list-outside pl-6 space-y-3 text-brand-ink">
                <li>
