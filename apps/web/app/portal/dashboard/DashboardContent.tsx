  ...
  return (
    <main className="relative w-full bg-brand-primary min-h-screen py-16 lg:py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="p-5 bg-brand-primary-800 border border-white/25 rounded-card">
            <p className="text-xs uppercase tracking-widest text-white/70 mb-1">Member since</p>
            <p className="text-white font-semibold">{formatMemberSince(memberSince)}</p>
          </div>
          <div className="p-5 bg-brand-primary-800 border border-white/25 rounded-card">
            <p className="text-xs uppercase tracking-widest text-white/70 mb-1">Programmes</p>
          ...
          <div className="p-5 bg-brand-primary-800 border border-white/25 rounded-card col-span-2 lg:col-span-1">
            <p className="text-xs uppercase tracking-widest text-white/70 mb-1">Membership tier</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {canAccessAssessments && (
                ...
                <Link
                  ...
                  className="group flex items-start gap-4 p-5 bg-brand-primary-800 hover:bg-brand-primary-700 border border-white/25 rounded-card transition-all duration-300"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-white/70 text-xs leading-relaxed">Pattern recognition, emotional mastery, life design</p>
                  </div>
                  <svg className="w-4 h-4 text-brand-accent-400 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity self-center" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              {canAccessVideos && (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-white/70 text-xs leading-relaxed">Recorded group coaching intensives</p>
                  </div>
                  <svg className="w-4 h-4 text-brand-accent-400 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity self-center" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                  </svg>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/70 text-xs leading-relaxed">Download all available resources</p>
                </div>
                <svg className="w-4 h-4 text-brand-accent-400 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity self-center" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                </svg>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/portal/programmes" className="text-brand-accent-400 text-sm hover:underline">
              View all
            </Link>
          </div>
          ...
          {programmes.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {programmes.slice(0, 3).map((programme) => (
                <Link
                  ...
                  className="group flex items-center gap-4 p-4 bg-brand-primary-800 hover:bg-brand-primary-700 border border-white/25 rounded-card transition-all duration-300"
                >
                  <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-white/10 flex items-center justify-center text-white">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-6 bg-brand-primary-800 border border-white/25 rounded-card">
              <div className="flex-1">
                <p className="text-white font-semibold mb-1">No programmes yet</p>
                <p className="text-white/70 text-sm">Browse Suzanne&apos;s coaching programmes and start your transformation.</p>
              </div>
              <Link
                href="/shop"
        ...
        >
          ...
          <div className="p-6 bg-brand-primary-800 border border-white/25 rounded-card">
          ...
          {/* Community CTA */}
          <div className="relative overflow-hidden p-6 bg-brand-primary-800 border border-white/25 rounded-card">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <motion.div
          ...
          className="mb-10 p-6 bg-brand-primary-800/60 border border-white/20 rounded-card"
        >
          <div className="flex items-center gap-3 mb-2">
            <h3 className="text-white font-semibold">Continue Learning</h3>
            <span className="text-xs text-white/60 font-medium uppercase tracking-widest">Coming soon</span>
          </div>
        ...
        {isFreeTier && (
          <motion.div
            ...
            className="relative overflow-hidden rounded-card bg-brand-primary-800 border border-white/25 p-8 lg:p-10"
          >
            <Image
            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center gap-8">
              ...
              <div className="flex-shrink-0 flex flex-col sm:flex-row gap-3">
                ...
                <Link
                  href="/shop"
                  className="inline-flex items-center justify-center px-8 py-4 border border-white/40 hover:border-white/60 text-white font-semibold rounded-button transition-colors duration-300"
                >
