    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.h2
          ...
          className="text-4xl lg:text-5xl font-medium tracking-tight text-brand-primary text-center mb-12"
        >
          Choose Your Path
        </motion.h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <motion.div
            {...cardReveal(0.35)}
            className="rounded-card bg-brand-sand border border-brand-border p-8 flex flex-col gap-6 hover:-translate-y-1 hover:shadow-2xl transition-all duration-300"
          >
            <h3 className="text-lg font-medium text-brand-primary">Other Ways to Connect</h3>

            <ul className="flex flex-col gap-5">
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-brand-accent mt-0.5 shrink-0" aria-hidden="true" />
                <div>
                  <p className="text-xs uppercase tracking-wider text-brand-muted mb-0.5">Email</p>
                  <a
            ...
            <div>
              <p className="text-xs uppercase tracking-wider text-brand-muted mb-4">Follow Along</p>
              <ul className="flex flex-col gap-3">
                <li>
                  <a
                    ...
                    aria-label="LinkedIn"
                    className="inline-flex items-center gap-3 text-brand-muted hover:text-brand-accent text-sm transition-colors group"
                  >
