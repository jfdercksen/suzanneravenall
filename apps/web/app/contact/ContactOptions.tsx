    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <motion.div
            {...cardReveal(0.15)}
            className="rounded-xl bg-brand-accent/10 border border-brand-accent p-8 flex flex-col"
          >
            <h3 className="text-lg font-semibold text-white mb-2">Book a Discovery Call</h3>
          ...
          <motion.div
            {...cardReveal(0.25)}
            className="rounded-xl bg-gray-900 border border-gray-800 p-8 flex flex-col"
          >
          ...
          <motion.div
            {...cardReveal(0.35)}
            className="rounded-xl bg-gray-900 border border-gray-800 p-8 flex flex-col gap-6"
          >
            ...
            <ul className="flex flex-col gap-5">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs uppercase tracking-wider text-white/40 mb-0.5">Location</p>
                  <span className="text-white/80 text-sm">Cape Town, South Africa</span>{/* [CONFIRM] */}
                </div>
              </li>
            </ul>

            <div>
              <p className="text-xs uppercase tracking-wider text-white/40 mb-4">Follow Along</p>
              <ul className="flex flex-col gap-3">
                <li>
                  <a
                    href="#"
                    aria-label="LinkedIn"
                    className="inline-flex items-center gap-3 text-white/70 hover:text-brand-accent text-sm transition-colors group"
                  >
