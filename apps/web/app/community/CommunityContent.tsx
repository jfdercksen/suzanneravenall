...
export default function CommunityContent() {
  ...
  return (
    <main className="w-full bg-brand-primary min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            ...
            >
              ...
              {state === 'success' ? (
                <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/30 rounded-xl max-w-md">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md">
                  ...
                  <button
                    type="submit"
                    disabled={state === 'loading'}
                    className="px-6 py-3.5 bg-brand-accent-600 hover:bg-brand-accent-700 text-white font-semibold rounded-xl transition-colors duration-300 disabled:opacity-60 whitespace-nowrap"
                  >
